                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <h3 className="mt-1 text-2xl font-bold text-gray-900">{productSummary.products}</h3>
                          <p className="mt-1 text-xs font-medium text-gray-600">
                            In {productSummary.categorys} categories
                          </p>
                        </div>
                ...
                <motion.div variants={itemVariants}>
                  <Card>
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm font-medium text-gray-500">Expiring Products</p>
                          <h3 className="mt-1 text-2xl font-bold text-gray-900">{productExpireSummary.products}</h3>
                          <p className="mt-1 text-xs font-medium text-gray-600">
                            In {productExpireSummary.categorys} categories
                          </p>
                        </div>
                    ...
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          ...
                          <h3 className="mt-1 text-2xl font-bold text-gray-900">{stockMaxMinSummary.stockMin.products}</h3>
                          <p className="mt-1 text-xs font-medium text-gray-600">
                            In {stockMaxMinSummary.stockMin.categorys} categories
                          </p>
                        </div>
                ...
                <motion.div variants={itemVariants}>
                  <Card>
                    <CardContent className="p-6">
                      <div className="flex items-center justify-between">
                        <div>
                          <p className="text-sm font-medium text-gray-500">Max Stock Products</p>
                          <h3 className="mt-1 text-2xl font-bold text-gray-900">{stockMaxMinSummary.stockMax.products}</h3>
                          <p className="mt-1 text-xs font-medium text-gray-600">
                            In {stockMaxMinSummary.stockMax.categorys} categories
                          </p>
                        </div>
                      ...
                      <div className="rounded-lg bg-amber-50 p-4">
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-amber-700">{stockMaxMinSummary.stockMin.products} items are below their minimum stock threshold</p>
                          </div>
                        </div>
                      </div>
                      <div className="rounded-lg bg-red-50 p-4">
                        <div className="flex items-start">
                          ...
                          <div>
                            ...
                            <p className="text-sm text-red-700">{productExpireSummary.products} products will expire soon</p>
                          </div>
                        </div>
                      </div>
                    </div>
