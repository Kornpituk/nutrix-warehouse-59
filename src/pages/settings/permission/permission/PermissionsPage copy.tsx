...
import { Plus, Search, Eye, MoreHorizontal, Edit, Copy, Trash2, ArrowLeft } from 'lucPermissionIde-react';
...
import { PermissionItem, PermissionNew  } from '@/types/settingType/permission/permission';
...
export default function PermissionsPage() {
  ...
  const handleDeletePermission = () => {
    if (selectedPermission) {
      setPermissions(permissions.filter(permission => permission.PermissionId !== selectedPermission.PermissionId));
    ...
    return (
      <div className="container mx-auto py-6">
        ...
        <div className="rounded-md border bg-white p-6 space-y-6">
          ...
          <div>
            <h2 className="font-medium mb-2">Code <span className="text-sm text-gray-500 font-normal">{selectedPermission.PermissionCode}</span></h2>
            <p className="text-sm text-gray-500">A unique code used to PermissionIdentify this permission in your system</p>
          </div>
          ...
          <div className="space-y-4 py-2">
            ...
            <div className="space-y-2">
              ...
              <Input 
                ...
                onChange={(e) => setNewPermissionCode(e.target.value)}
              />
              <p className="text-xs text-gray-500">A unique code used to PermissionIdentify this permission in your system</p>
            </div>
            <div className="space-y-2">
