        ...
        <div className="container mx-auto px-4 py-20 sm:py-32">
          <nav className="flex items-center justify-between py-4">
            <div className="flex items-center space-x-2">
              ...
              <span className="text-xl font-bold text-primary">
                {companyData?.companyName || "Nutrix Public Company Limited"}
              </span>
            </div>
          ...
          <div className="mt-16 flex flex-col-reverse items-center lg:flex-row lg:items-start lg:justify-between">
            ...
            >
              ...
              >
                Streamline your pet food inventory with our intuitive warehouse
                management system. Track, manage, and optimize your pet food
              ...
              <div className="scene-container absolute inset-0 mx-auto">
                <div className="cube">
                  <div className="cube__face cube__face--front">
                    <motion.img
                      src="https://cdn.pixabay.com/photo/2020/04/26/14/45/cat-5095534_1280.jpg"
                      alt="Dog with food"
        ...
        >
          ...
          >
            <path
              fill="#f3f4f6"
              fillOpacity="1"
              d="M0,224L48,224C96,224,192,224,288,208C384,192,480,160,576,165.3C672,171,768,213,864,213.3C960,213,1056,171,1152,149.3C1248,128,1344,128,1392,128L1440,128L1440,320L1392,320C1344,320,1248,320,1152,320C1056,320,960,320,864,320C768,320,672,320,576,320C480,320,384,320,288,320C192,320,96,320,48,320L0,320Z"
            ></path>
          </svg>
        </motion.div>
      </header>
        ...
        <div className="container mx-auto px-4">
          ...
          >
            ...
            <p className="mt-4 text-xl text-gray-600">
              Everything you need to manage your pet food inventory
            </p>
          </motion.div>
            ...
            {[
              {
                ...
                description:
                  "Get instant insights into your inventory and operations with our intuitive dashboard.",
                icon: (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
              ...
              },
              {
                ...
                description:
                  "Track inventory levels, set alerts, and manage stock with ease.",
                icon: (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-10 w-10 text-primary"
              ...
              },
              {
                ...
                description:
                  "Plan and track shipments in real-time with comprehensive reports.",
                icon: (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-10 w-10 text-primary"
              ...
              },
              {
                ...
                description:
                  "Manage multiple warehouses and zones from one central dashboard.",
                icon: (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-10 w-10 text-primary"
              ...
              },
              {
                ...
                description:
                  "Keep track of shelf life and expiry dates for all your pet food products.",
                icon: (
                  <svg
                    xmlns="http://www.w3.org/2000/svg"
                    className="h-10 w-10 text-primary"
        ...
        <div className="container mx-auto px-4">
          ...
          >
            <h2 className="mb-6 text-3xl font-bold text-white">
              Ready to optimize your pet food warehouse?
            </h2>
        ...
        <div className="container mx-auto px-4">
          <div className="flex flex-col items-center justify-between space-y-6 md:flex-row md:space-y-0">
            <div className="flex items-center space-x-2">
              ...
              >
                <path
                  d="M16 4C9.4 4 4 9.4 4 16C4 22.6 9.4 28 16 28C22.6 28 28 22.6 28 16C28 9.4 22.6 4 16 4ZM16 26C10.5 26 6 21.5 6 16C6 10.5 10.5 6 16 6C21.5 6 26 10.5 26 16C26 21.5 21.5 26 16 26Z"
                  fill="#AB0006"
                />
                <path
                  d="M16 10C13.8 10 12 11.8 12 14C12 16.2 13.8 18 16 18C18.2 18 20 16.2 20 14C20 11.8 18.2 10 16 10Z"
                  fill="#AB0006"
                />
                <path
                  d="M13 20C11 20 10 22 10 23C10 24 10.5 25 12 25C13.5 25 14.5 24 15 23C15.5 22 15 20 13 20Z"
