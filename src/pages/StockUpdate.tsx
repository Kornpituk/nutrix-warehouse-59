...
// Mock data for the stock list
const stockItems = [
  {
    id: 1,
    image: 'https://images.unsplash.com/photo-1568640347023-a616a30bc3bd?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80',
    itemCode: 'DF-1001',
  ...
  {
    id: 2,
    image: 'https://images.unsplash.com/photo-1589924691995-400dc9ecc119?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80',
    itemCode: 'CF-2001',
  ...
  {
    id: 3,
    image: 'https://images.unsplash.com/photo-1601758124510-52d02ddb7cbd?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80',
    itemCode: 'DF-1002',
  ...
  {
    id: 4,
    image: 'https://images.unsplash.com/photo-1607246749396-c1c289bc2227?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80',
    itemCode: 'CF-2002',
  ...
  {
    id: 5,
    image: 'https://images.unsplash.com/photo-1603047384516-2658696884a7?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80',
    itemCode: 'BF-3001',
  ...
  {
    id: 6,
    image: 'https://images.unsplash.com/photo-1597843786411-a7fa8ad44a95?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80',
    itemCode: 'FF-4001',
  ...
  {
    id: 7,
    image: 'https://images.unsplash.com/photo-1585846888147-3fe14c130048?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80',
    itemCode: 'DF-1003',
  ...
  {
    id: 8,
    image: 'https://images.unsplash.com/photo-1608408832581-9c2b8c5a41fa?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80',
    itemCode: 'CF-2003',
  ...
  {
    id: 9,
    image: 'https://images.unsplash.com/photo-1591154669695-5f2a8d20c089?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80',
    itemCode: 'DF-1004',
  ...
  {
    id: 10,
    image: 'https://images.unsplash.com/photo-1571566882372-1598d88abd90?ixlib=rb-4.0.3&auto=format&fit=crop&w=100&q=80',
    itemCode: 'SF-5001',
...
const StockUpdate = () => {
  ...
  useEffect(() => {
    // Filter the items based on the search term and filters
  ...
  }, [searchTerm, selectedWarehouse, selectedZone, selectedArea, selectedCategory, sortColumn, sortDirection]);
    ...
    return (
      <div className="flex h-screen items-center justify-center">
        <div className="text-center">
          ...
          <p className="mt-3 text-lg font-medium text-gray-600">Loading stock data...</p>
        </div>
      </div>
    );
  }
              ...
              <Table>
                <TableHeader>
                  <TableRow>
                    ...
                    <TableHead className="cursor-pointer" onClick={() => handleSort('lot')}>
                      <div className="flex items-center">
                        Lot
                        {renderSortIndicator('lot')}
                      </div>
                    </TableHead>
                    <TableHead className="cursor-pointer text-right" onClick={() => handleSort('lotQty')}>
                      <div className="flex items-center justify-end">
                        Lot Qty
                        {renderSortIndicator('lotQty')}
                      </div>
                    </TableHead>
                    <TableHead className="cursor-pointer text-right" onClick={() => handleSort('totalQty')}>
                      <div className="flex items-center justify-end">
                        Total Qty
                    ...
                    <TableHead className="cursor-pointer text-right" onClick={() => handleSort('shelfLife')}>
                      <div className="flex items-center justify-end">
                        Shelf Life (days)
                        {renderSortIndicator('shelfLife')}
                      </div>
                    </TableHead>
                    <TableHead className="cursor-pointer text-right" onClick={() => handleSort('expiryDays')}>
                      <div className="flex items-center justify-end">
                        Expiry Days
                  ...
                  {filteredItems.length === 0 ? (
                    ...
                    filteredItems.map((item, index) => (
                      <TableRow key={item.id}>
                        ...
                        <TableCell className="text-right">{item.lotQty.toLocaleString()}</TableCell>
                        <TableCell className="text-right">{item.totalQty.toLocaleString()}</TableCell>
                        <TableCell>{item.uom}</TableCell>
                        <TableCell>{item.warehouse}</TableCell>
                        <TableCell>{item.zone}</TableCell>
                        <TableCell>{item.area}</TableCell>
                        <TableCell className="text-right">{item.shelfLife}</TableCell>
                        <TableCell className="text-right">
                          <span className={
                            item.expiryDays < 30 ? 'text-red-600' : 
                            item.expiryDays < 90 ? 'text-amber-600' : 
                            'text-green-600'
                          }>
                            {item.expiryDays}
                          </span>
          ...
          {selectedItem && (
            <div className="grid gap-6 md:grid-cols-2">
              ...
              <div className="space-y-4">
                <div>
                  <h3 className="text-xl font-bold text-gray-900">{selectedItem.itemName}</h3>
                ...
                <div className="grid grid-cols-2 gap-2">
                  ...
                  <div className="space-y-1">
                    ...
                    <p className="text-sm font-medium">{selectedItem.lotQty} {selectedItem.uom}</p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-xs text-gray-500">Total Quantity</p>
                    <p className="text-sm font-medium">{selectedItem.totalQty} {selectedItem.uom}</p>
                  </div>
                </div>
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <p className="text-sm font-medium">{selectedItem.warehouse}</p>
                  </div>
                  <div className="flex justify-between">
                ...
                <div className="space-y-2">
                  <div className="flex justify-between">
                    ...
                    <p className="text-sm font-medium">{selectedItem.shelfLife} days</p>
                  </div>
                  <div className="flex justify-between">
                    <p className="text-xs text-gray-500">Expiry In</p>
                    <p className={`text-sm font-medium ${
                      selectedItem.expiryDays < 30 ? 'text-red-600' : 
                      selectedItem.expiryDays < 90 ? 'text-amber-600' : 
                      'text-green-600'
                    }`}>
